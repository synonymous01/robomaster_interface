...
class handler:
    ...
    def get_state_vector(self):
        ...
        trans = tfbuffer.lookup_transform('world', 'robot1_odom_combined', rospy.Time(), rospy.Duration(3))
        poses[0, 0] = trans.transform.translation.x
        poses[1, 0] = trans.transform.translation.y

        trans = tfbuffer.lookup_transform('world', 'robot3_odom_combined', rospy.Time(), rospy.Duration(3.0))
